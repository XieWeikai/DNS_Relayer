...
同时我们也对参考程序 `dnsrelay.exe` 进行了同样的测试, 结果如下 (左为 8.8.8.8, 右为 `dnsrelay.exe`):

![test_result](doc/img/test_result_2.png)

从结果来看三次测试 (Google DNS/我们的中继器/参考中继器) 结果几乎相同, 都能接受高并发查询.
